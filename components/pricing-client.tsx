...
import { Code2, Palette, BarChart3, Shield, Check, Server, Cloud, Search } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { cn } from '@/lib/utils'
import { motion } from 'framer-motion'
import type { DBProduct } from '@/lib/product-store'
            ...
            return (
              ...
              >
                ...
                <div className={cn(
                  ...
                  {product.imageUrl ? (
                    <img 
                      src={`/api/file?pathname=${encodeURIComponent(product.imageUrl)}`}
                      alt={product.name}
                      className="relative z-10 h-20 w-20 rounded-2xl object-cover"
                    />
                  ) : (
                    <motion.div
